    ...
    <div className="mt-6" data-aos="fade-left">
        <div className="h-[220px] w-[80%]  rounded-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
            ...
            <div className="pt-2 pl-5">
                <h1 className="text-[20px] text-gray-600 tracking-wider bg-gray-100 shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:underline"><a href={link} target="_blank" rel="noopener noreferrer"> {college} </a></h1>
                <h1 className="text-lg text-gray-400 tracking-wider pt-3 ">{address}</h1>
            </div>
            <div className="mt-5 ml-4 h-9 w-[300px] bg-gray-200 items-center">
                <h1 className="pl-6 text-2xl text-blue-500 font-semibold font-mono">{score}</h1>
            </div>
        </div>
