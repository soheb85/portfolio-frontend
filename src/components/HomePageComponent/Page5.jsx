...
const Page5 = () => {
    const projects = [
        ...
        {name:"Cricket Auction System",para:"Auction Players using React-js and Tailwindcss",link:"https://github.com/soheb85/CricketAuctionSystem", image:"/Screenshot 2025-02-16 042536.png",aos:"zoom-out-right"},
    ]
  return (
